	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/", "/favicon.ico", "/**/*.png", "/**/*.gif", "/**/*.svg", "/**/*.jpg", "/**/*.html",
						"/**/*.css", "/**/*.js")
				.permitAll().antMatchers("/mkt/auth/**").permitAll()
				.antMatchers("/mkt/user/checkUsernameAvailability", "/mkt/user/checkEmailAvailability").permitAll()
				.antMatchers(HttpMethod.GET, "/mkt/projects/**", "/mkt/users/**").permitAll().anyRequest()
				.authenticated();
