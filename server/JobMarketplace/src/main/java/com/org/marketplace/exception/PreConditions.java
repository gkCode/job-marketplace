...
public final class PreConditions {
	 ...
	 * @param errorMessageTemplate  The template that is used to construct the
	 *                              message of the exception thrown if the inspected
	 *                              exception is false. The template must use the
	 *                              syntax that is supported by the
	 *                              {@link java.lang.String#format(String, Object...)}
	 *                              method.
	 * @param errorMessageArguments The arguments that are used when the message of
	 *                              the thrown exception is constructed.
	 * @throws java.lang.IllegalArgumentException if the inspected exception is
	 *         false.
	 */
	 ...
	 * 
	 * @param expression   The inspected expression.
	 * @param errorMessage The error message that is passed forward to the exception
	 *                     that is thrown if the expression is false.
	 * @throws java.lang.IllegalArgumentException if the inspected expression is
	 *         false.
	 */
	 ...
	 * @param errorMessage The error message that is passed forward to the exception
	 *                     that is thrown if the string is empty.
	 ...
	 * @param errorMessage The error message that is passed forward to the exception
	 *                     that is thrown if the object given as a method parameter
	 *                     is null.
	 * @throws java.lang.NullPointerException If the object given as a method
	 *         parameter is null.
	 */
