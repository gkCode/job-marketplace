...
export declare const CustomSummary: React.ComponentType<CustomSummaryProps>;
...
/** Describes a filter operation. Accepts one of the built-in operations or a custom string.Built-in operations: `contains`, `notContains`, `startsWith`, `endsWith`, `equal`, `notEqual`, `greaterThan`, `graterThenOrEqual`, `lessThan`, `lessThanOrEqual` */
...
export declare const IntegratedSummary: React.ComponentType<IntegratedSummaryProps> & {
...
/** Describes a filter operation. Accepts a built-in operation or custom string.Built-in operations: `sum`, `max`, `min`, `avg`, `count`. */
...
export declare const SummaryState: React.ComponentType<SummaryStateProps>;
